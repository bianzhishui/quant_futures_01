...
| 11 | 组合筛选器 | [screener_plan.md](screener_plan.md) | ✅ **正式采纳** | 组合 6m +7.3% / 12m +17.4% | **贱极∧政策宽松组合超额约为纯贱极 2 倍**（33 事件）；纳入日常工具（机器筛→人工确认→决策）；当前（2026-09）候选 0 个、M2 收紧 |
...
11. **组合筛选器（screener_plan.md，✅ 正式采纳）**：贱极∧政策宽松组合 6m **+7.3%** / 12m **+17.4%**（约为纯贱极 2 倍，33 事件）；纳入日常工具（机器筛→人工确认→决策，只筛不决）；当前（2026-09）候选 0 个、M2 收紧——等待信号。
